                    ...
                    <div class="a-section auth-pagelet-container">
                        <div class="a-section a-spacing-base">
                            <div class="a-section">
                                ...
                                <form name="signIn" @submit.prevent="doLogin"
                                        ...
                                        <div class="a-box">
                                            <div class="a-box-inner a-padding-extra-large">
                                                ...
                                                <div class="a-row a-spacing-base">
                                                    ...
                                                    <input v-model="email" type="email" maxlength="128" id="ap_email"
                                                        autocomplete="username" name="email" spellcheck="false"
                                                ...
                                                <div class="a-section a-spacing-large">
                                                    ...
                                                    <input v-model="password" type="password" maxlength="1024"
                                                        id="ap_password" autocomplete="current-password" name="password"
                                                        spellcheck="false"
                                                ...
                                                <div class="a-section a-spacing-extra-large">
                                                    <span
                                                        class="a-button a-button-span12 a-button-primary auth-disable-button-on-submit"
                                                        id="a-autoid-0"><span class="a-button-inner"><input
                                                                id="signInSubmit" class="a-button-input" type="submit">
                                                    ...
                                                    <div class="a-row a-spacing-top-medium">
                                                        <div class="a-section a-text-left">
                                                            <label for="auth-remember-me" class="a-form-label">
                                                                ...
                                                                <input type="hidden" name="kmsiWeblabTreatment"
                                                                    value="C" id="kmsi-weblab-treatment">
                                                                        ...
                                                                        <span class="a-label a-checkbox-label">
                                                                            ...
                                                                            <span class="a-declarative">
                                                                                <a id="remember_me_learn_more_link"
                                                                                    aria-label="Details about Keep Me Signed In"
                                                ...
                                                <span id="auth-create-account-link"
                                                    ...
                                                    <span class="a-button-inner">
                                                        <router-link id="createAccountSubmit" to="/register"
                                                            class="a-button-text">
