...
const cityOptions = computed(() => {
  return country ? citiesByCountry[country.value] : [];
});
</script>
        ...
        <div class="a-section a-padding-medium auth-workflow">
            <div class="a-section a-spacing-none auth-navbar">
                <div class="a-section a-spacing-medium a-text-center">
                    <a class="a-link-nav-icon" href="https://www.imdb.com/">
                ...
                <div id="authportal-main-section" class="a-section">
                    <div class="a-section auth-pagelet-container">
                        <div class="a-section">
                            ...
                            <form @submit.prevent="doRegister" id="ap_register_form" name="register"
                                class="a-spacing-none auth-validate-form auth-real-time-validation auth-real-time-validation auth-validate-form-moa">
                                <div class="a-box a-spacing-extra-large">
                                    <div class="a-box-inner">
                                        ...
                                        <div class="a-row a-spacing-base">
                                            ...
                                            <input v-model="name" type="text" maxlength="50" id="ap_customer_name" autocomplete="name"
                                                placeholder="First and last name" name="customerName" spellcheck="false"
                                                class="a-input-text a-span12 auth-required-field auth-contact-verification-request-info"
                                                required>
                                        </div>
                                        <div class="auth-require-fields-match-group">
                                            <div class="a-row a-spacing-base">
                                                ...
                                                <input v-model="email" type="email" maxlength="64" id="ap_email" autocomplete="email"
                                                    name="email" spellcheck="false"
                                                    class="a-input-text a-span12 auth-required-field auth-require-fields-match auth-require-email-validaton auth-require-reverify-on-change auth-contact-verification-request-info auth-require-email-validaton"
                                        ...
                                        <div class="auth-require-fields-match-group">
                                            <div class="a-row a-spacing-base">
                                                ...
                                                <input v-model="password" type="password" maxlength="1024" id="ap_password"
                                                    autocomplete="new-password" placeholder="at least 8 characters"
                                                    name="password" spellcheck="false"
                                                    class="a-input-text a-form-normal a-span12 auth-required-field auth-require-fields-match auth-require-password-validation" required>
                                                <div id="ap_password_context_message_section"
                                                    class="a-section a-spacing-none">
                                                    <div id="auth-password-requirement-info"
                                                        class="a-box a-alert-inline a-alert-inline-info auth-inlined-information-message a-spacing-top-base">
                                                        <div class="a-box-inner a-alert-container"><i
                                                                class="a-icon a-icon-alert"></i>
                                                            <div class="a-alert-content">
                                                                Passwords must be at least 8 characters. Password must have at least 1 number and special character.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="a-row a-spacing-base">
                                                ...
                                                <input v-model="confirmPassword" type="password" required maxlength="1024" id="ap_password_check"
                                                    autocomplete="new-password" name="passwordCheck" spellcheck="false"
                                                    class="a-input-text a-form-normal a-span12 auth-required-field auth-require-fields-match"
                                                    >
                                            </div>
                                            <div class="a-row a-spacing-base a-span12" style="display: flex; gap: 16px;">
                                                <div class="a-span6">
                                                    <label for="country" class="a-form-label">Country</label>
                                                    <select id="country" name="country" v-model="country"
                                                            class="a-input-text a-form-normal a-span12 auth-required-field" aria-required="true">
                                                ...
                                                <div class="a-span6">
                                                    ...
                                                    <select id="city" v-model="city"
                                                            class="a-input-text a-form-normal a-span12 auth-required-field">
                                        ...
                                        <div class="a-row a-spacing-extra-large">
                                            <span class="a-button a-button-normal a-button-span12 a-button-primary"
                                                ...
                                                <span class="a-button-inner">
                                                    ...
                                                    <span class="a-button-text" id="a-autoid-0-announce">
                                        ...
                                        <div class="a-row">
                                            ...
                                            <router-link class="a-link-emphasis" to="/signin">
                                                Sign in
                                            </router-link>
                                        </div>
                                    </div>
...
.a-icon-heart-on {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
...
.a-hires .a-icon-heart-on.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon-heart-off.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-heart-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon-heart-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon-heart-off-hover {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-heart-off-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon-heart-off-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon-heart-off-active {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-heart-off-active.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon-heart-off-active.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon-heart-on-active {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-heart-on-active.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon-heart-on-active.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-heart-on-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon-heart-on-hover.a-icon-small {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon-jp {
    background-image: url(https://m.media-amazon.com/images/S/sash/h$0-hoWNYbuvG-5.png);
    -webkit-background-size: 128px 16px;
    background-size: 128px 16px
}

.a-hires .a-icon-jp {
    background-image: url(https://m.media-amazon.com/images/S/sash/QKIUuPGecMU39kT.png)
}
...
.a-share-wechat,
.a-share-whatsapp {
    background-image: url(https://m.media-amazon.com/images/S/sash/ZpbG74laklgnz-i.png);
    -webkit-background-size: 512px 256px;
    background-size: 512px 256px;
    background-repeat: no-repeat
}

.a-hires .a-icon-amazon-app,
.a-hires .a-icon-autorip,
.a-hires .a-icon-fba,
.a-hires .a-icon-fresh,
.a-hires .a-icon-kindle-unlimited-headphones,
.a-hires .a-icon-logo,
.a-hires .a-icon-logo-china,
.a-hires .a-icon-premium,
.a-hires .a-icon-premium-nav,
.a-hires .a-icon-prime,
.a-hires .a-icon-prime-campus,
.a-hires .a-icon-prime-fresh,
.a-hires .a-icon-prime-headphones,
.a-hires .a-icon-prime-jp,
.a-hires .a-icon-prime-jp-nav,
.a-hires .a-icon-prime-nav,
.a-hires .a-icon-prime-pass,
.a-hires .a-icon-prime-wardrobe-badge,
.a-hires .a-icon-prime-wardrobe-logo,
.a-hires .a-icon-primefresh-nav,
.a-hires .a-icon-share-douban,
.a-hires .a-icon-share-email,
.a-hires .a-icon-share-facebook,
.a-hires .a-icon-share-kaixin001,
.a-hires .a-icon-share-line,
.a-hires .a-icon-share-link,
.a-hires .a-icon-share-mixi,
.a-hires .a-icon-share-pengyou,
.a-hires .a-icon-share-pinterest,
.a-hires .a-icon-share-qq,
.a-hires .a-icon-share-qzone,
.a-hires .a-icon-share-renren,
.a-hires .a-icon-share-sina,
.a-hires .a-icon-share-sms,
.a-hires .a-icon-share-tencent,
.a-hires .a-icon-share-twitter,
.a-hires .a-icon-share-wechat,
.a-hires .a-icon-share-whatsapp,
.a-hires .a-icon-smile,
.a-hires .a-logo,
.a-hires .a-logo-china,
.a-hires .a-premium-logo,
.a-hires .a-premium-nav-logo,
.a-hires .a-prime-jp-logo,
.a-hires .a-prime-jp-nav-logo,
.a-hires .a-prime-logo,
.a-hires .a-prime-nav-logo,
.a-hires .a-share-douban,
.a-hires .a-share-email,
.a-hires .a-share-facebook,
.a-hires .a-share-kaixin001,
.a-hires .a-share-line,
.a-hires .a-share-link,
.a-hires .a-share-mixi,
.a-hires .a-share-pengyou,
.a-hires .a-share-pinterest,
.a-hires .a-share-qq,
.a-hires .a-share-qzone,
.a-hires .a-share-renren,
.a-hires .a-share-sina,
.a-hires .a-share-sms,
.a-hires .a-share-tencent,
.a-hires .a-share-twitter,
.a-hires .a-share-wechat,
.a-hires .a-share-whatsapp {
    background-image: url(https://m.media-amazon.com/images/S/sash/boj0uoPgGPaQ-QZ.png)
}
...
.a-icon-kindle-unlimited-fr {
    background-image: url(https://m.media-amazon.com/images/S/sash/qTsB$0ghAfMhSIm.png);
    -webkit-background-size: 128px 16px;
    background-size: 128px 16px;
    width: 86px;
    height: 10px;
...
.a-hires .a-icon-kindle-unlimited-fr {
    background-image: url(https://m.media-amazon.com/images/S/sash/Rmgvs6RugqtdnwT.png)
}
...
.a-hires .a-icon-pantry,
.a-hires .a-icon-prime-pantry {
    background-image: url(https://m.media-amazon.com/images/S/sash/boj0uoPgGPaQ-QZ.png)
}
...
.a-icon.a-icon-error,
.a-icon.a-icon-info,
.a-icon.a-icon-success,
.a-icon.a-icon-warning {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon.a-icon-error,
.a-hires .a-icon.a-icon-info,
.a-hires .a-icon.a-icon-success,
.a-hires .a-icon.a-icon-warning {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon.a-icon-base-add,
.a-icon.a-icon-base-add-disabled,
.a-icon.a-icon-base-remove,
.a-icon.a-icon-base-remove-disabled,
.a-icon.a-icon-base-trash,
.a-icon.a-icon-base-trash-disabled {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires .a-icon.a-icon-base-add,
.a-hires .a-icon.a-icon-base-add-disabled,
.a-hires .a-icon.a-icon-base-remove,
.a-hires .a-icon.a-icon-base-remove-disabled,
.a-hires .a-icon.a-icon-base-trash,
.a-hires .a-icon.a-icon-base-trash-disabled {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon.a-icon-small-add,
.a-hires .a-icon.a-icon-small-add-disabled,
.a-hires .a-icon.a-icon-small-remove,
.a-hires .a-icon.a-icon-small-remove-disabled,
.a-hires .a-icon.a-icon-small-trash,
.a-hires .a-icon.a-icon-small-trash-disabled {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon.a-icon-chevron-down {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon.a-icon-chevron-up {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon.a-icon-close-filter {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon-star-large,
.a-hires .a-icon-star-large-full,
.a-hires .a-icon-star-large-hover {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-icon.a-icon-heart-hollow-dark,
.a-icon.a-icon-heart-hollow-light,
.a-icon.a-icon-heart-solid-red {
    background-image: url(https://m.media-amazon.com/images/S/sash/uDspLSCREvEXFJc.png);
    -webkit-background-size: 26px 78px;
    background-size: 26px 78px
}

.a-hires .a-icon.a-icon-heart-hollow-dark,
.a-hires .a-icon.a-icon-heart-hollow-light,
.a-hires .a-icon.a-icon-heart-solid-red {
    background-image: url(https://m.media-amazon.com/images/S/sash/FtyrfMTkFvztJoW.png)
}
...
.a-icon-VOB-restricted {
    background-image: url(https://m.media-amazon.com/images/S/sash/FnGh4fljd-s5Ueo.png);
    -webkit-background-size: 512px 64px;
    background-size: 512px 64px;
    background-repeat: no-repeat
}

.a-hires .a-icon-VOB-blocked,
.a-hires .a-icon-VOB-info,
.a-hires .a-icon-VOB-preferred,
.a-hires .a-icon-VOB-restricted {
    background-image: url(https://m.media-amazon.com/images/S/sash/k4lWlt72B2nDfN7.png)
}
...
.a-icon.a-accordion-radio,
.a-icon.a-icon-checkbox,
.a-icon.a-icon-radio {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
...
.a-hires .a-icon.a-accordion-radio,
.a-hires .a-icon.a-icon-checkbox,
.a-hires .a-icon.a-icon-radio {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-hires .a-icon.a-icon-calendar,
.a-hires .a-icon.a-icon-close,
.a-hires .a-icon.a-profile-verified-badge {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-button:hover.a-button-v2-basic:focus:active {
    background-color: var(--__N4QdChibkloe, #edf8ff)
}
...
.a-button:focus {
    outline-color: var(--__dChMYZxR-, #2162a1);
    outline-offset: 2px;
    outline-width: 3px;
    outline-style: solid;
    box-shadow: none;
...
.a-button-toggle:hover {
    border-color: var(--__N4QdChTxpfIs, #0a7cd1);
    background-color: var(--__N4QdChibkfIs, #edf8ff)
}
...
.a-button-toggle:active:not(.a-button-disabled) {
    ...
    outline-style: solid;
    box-shadow: none;
    border-color: var(--__N4QdChTxploe, #1c89e3);
...
.a-button-group .a-button.a-button-selected {
    border-color: var(--__N4QdChTxp18u, #2162a1);
    position: relative;
    z-index: 2;
    overflow: visible
}
...
.a-button-group .a-button.a-button-selected .a-button-inner {
    background-color: var(--__N4QdChibk18u, #edf8ff)
}
...
a:visited {
    text-decoration: none;
    color: var(--__N4QdChsbGN6j, #2162a1)
}
...
.a-color-link {
    color: var(--__N4QdChsbGN6j, #2162a1) !important
}
...
a:active {
    text-decoration: underline;
    color: var(--__N4QdChsbGloe, #0c3353)
}
...
.a-cardui-expand-control-footer:active .a-see-more {
    text-decoration: underline;
    color: var(--__N4QdChsbGloe, #0c3353) !important
}
...
a:hover {
    text-decoration: underline;
    cursor: pointer;
    color: var(--__N4QdChsbGfIs, #0c3353)
}

a:hover.a-color-base {
    color: var(--__N4QdChsbGfIs, #0c3353) !important
}
...
[data-a-atomic-interop][data-a-component=filter][data-a-selected] [data-a-selector=filter-icon] {
    background-image: url(https://m.media-amazon.com/images/S/sash/2KViI4b7ZZCNtr3.png);
    -webkit-background-size: 512px 512px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.a-hires [data-a-atomic-interop][data-a-component=filter][data-a-selected] [data-a-selector=filter-icon] {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
.a-spinner-small {
    ...
    background: url(https://m.media-amazon.com/images/S/sash/CKWYNOHAO2meoCm.png) 50% 50% no-repeat
}
...
.a-hires .a-spinner-medium {
    background: url(https://m.media-amazon.com/images/S/sash/-0k$2FlUkg9tyD3.png) 50% 50% no-repeat;
...
.a-carousel-card-empty {
    background: url(https://m.media-amazon.com/images/S/sash/-NcRiM84u1IwoUa.gif) 50% 50% no-repeat
}

@media only screen and (-webkit-min-device-pixel-ratio:1.5),
only screen and (min-resolution:144dpi) {
    .a-carousel-card-empty {
        background: url(https://m.media-amazon.com/images/S/sash/prp2-N9d2Q$gDX5.gif) 50% 50% no-repeat;
...
ul.a-viewoptions-list li.a-viewoptions-list-item.a-selected a {
    font-weight: 700;
    color: var(--__N4QdChsbGqWp, #2162a1);
...
ul.a-tabs li a:active {
    color: var(--__N4QdCheV618u, #2162a1);
...
.a-hires .a-switch-control::after {
    background-image: url(https://m.media-amazon.com/images/S/sash/rYl2U4vajeeRGLE.png)
}
...
@font-face {
    font-family: 'Amazon Ember';
    src: url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff2) format("woff2"), url(https://m.media-amazon.com/images/G/01/wg/assets/fonts/AmazonEmber_W_Bd.woff) format("woff");
    font-style: normal;
    font-weight: 700
}
...
#aui-overrides-mase #mase-desktop #mase-override-error-alert-box .a-icon.a-icon-alert {
...
#aui-overrides-mase #mase-desktop #mase-override-box .a-icon.a-icon-checkbox.confirmChangeDefaultCheckboxChecked {
    border-radius: 2px;
...
#aui-overrides-mase #mase-desktop #mase-override-box .a-icon.a-icon-checkbox {
    border-radius: 2px;
...
#aui-overrides-mase #mase-desktop #auth-emailNew-invalid-email-alert .a-icon.a-icon-alert,
#aui-overrides-mase #mase-desktop #auth-emailNew-missing-alert .a-icon.a-icon-alert,
#aui-overrides-mase #mase-desktop #changeDefaultCheckboxErrorMessage .a-icon.a-icon-alert,
#aui-overrides-mase #mase-desktop #repair-mase-inlineerror .a-icon.a-icon-alert {
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
...
#aui-overrides-mase #mase-mobile .a-icon.a-icon-checkbox.confirmChangeDefaultCheckboxChecked {
    border-radius: .2rem;
    background-position-x: -8.4rem !important;
    background-position-y: -23.3rem !important;
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
    background-size: 51.2rem 51.2rem
}

#aui-overrides-mase #mase-mobile .a-icon.a-icon-checkbox {
    border-radius: .2rem;
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
    background-position-x: -8.4rem !important;
    background-position-y: -20.8rem !important;
    background-size: 51.2rem 51.2rem
}
...
#aui-overrides-mase #mase-mobile #auth-emailNew-invalid-email-alert .a-icon.a-icon-alert,
#aui-overrides-mase #mase-mobile #auth-emailNew-missing-alert .a-icon.a-icon-alert,
#aui-overrides-mase #mase-mobile #changeDefaultCheckboxErrorMessage .a-icon.a-icon-alert,
#aui-overrides-mase #mase-mobile #repair-mase-inlineerror .a-icon.a-icon-alert {
    height: 1.8rem;
    width: 1.8rem;
    top: .1rem;
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
    background-position-x: -45.2rem;
    background-position-y: -42.2rem;
    background-size: 51.2rem 51.2rem
}
...
#mase-default-sign-in-desktop #auth-password-missing-alert .a-icon.a-icon-alert {
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
    background-position-x: -452px;
    background-position-y: -422px;
    background-size: 512px 512px;
...
#mase-default-sign-in-mobile #auth-password-missing-alert .a-icon.a-icon-alert {
    height: 1.8rem;
    width: 1.8rem;
    top: .1rem;
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
...
html[dir=rtl] #aui-overrides-mase #mase-desktop #auth-emailNew-invalid-email-alert .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-desktop #auth-emailNew-missing-alert .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-desktop #changeDefaultCheckboxErrorMessage .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-desktop #repair-mase-inlineerror .a-box-inner.a-alert-container {
    padding-right: 28px
}

html[dir=rtl] #aui-overrides-mase #mase-desktop #auth-emailNew-invalid-email-alert .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-desktop #auth-emailNew-missing-alert .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-desktop #changeDefaultCheckboxErrorMessage .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-desktop #repair-mase-inlineerror .a-icon.a-icon-alert {
    right: 2px
}

html[dir=rtl] #aui-overrides-mase #mase-desktop #mase-override-box .a-icon.a-icon-collapse,
html[dir=rtl] #aui-overrides-mase #mase-desktop #mase-override-box .a-icon.a-icon-expand {
    height: 7px;
    width: 7px;
    margin-left: -3px;
    background-image: none;
...
html[dir=rtl] #aui-overrides-mase #mase-mobile #auth-emailNew-invalid-email-alert .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-mobile #auth-emailNew-missing-alert .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-mobile #changeDefaultCheckboxErrorMessage .a-box-inner.a-alert-container,
html[dir=rtl] #aui-overrides-mase #mase-mobile #repair-mase-inlineerror .a-box-inner.a-alert-container {
    padding-right: 2.8rem
}

html[dir=rtl] #aui-overrides-mase #mase-mobile #auth-emailNew-invalid-email-alert .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-mobile #auth-emailNew-missing-alert .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-mobile #changeDefaultCheckboxErrorMessage .a-icon.a-icon-alert,
html[dir=rtl] #aui-overrides-mase #mase-mobile #repair-mase-inlineerror .a-icon.a-icon-alert {
    right: .2rem
}

html[dir=rtl] #aui-overrides-mase #mase-mobile #aui-overrides-mase-expander-mobile .a-icon.a-icon-collapse,
html[dir=rtl] #aui-overrides-mase #mase-mobile #aui-overrides-mase-expander-mobile .a-icon.a-icon-expand {
    height: .7rem;
    width: .7rem;
    margin-left: .2rem;
    background-image: none;
...
#aui-overrides-passwordless #passwordless-desktop #add-password-passwordless-message .a-icon.a-icon-alert {
    background-image: url(https://m.media-amazon.com/images/S/sash/HUihy0LFGrc$BRd.png);
...
#untrusted-app-sign-in-accept-risk .a-icon.a-icon-alert {
    background-image: url(https://m.media-amazon.com/images/S/sash/ZNt8quAxIfEMMky.png);
    background-position: -452px -422px;
    background-size: 512px 512px;
    background-repeat: no-repeat;
...
.ap-adam-breadcrumb-list li:after {
    content: ">";
    padding-left: 4px
}

.ap-adam-breadcrumb-list li:last-child:after {
    content: "";
    padding-right: 0
}
